//
// Created by Eric Younger on 09/09/2020.
//
...
Fraction Fraction::operator-(int wholenumber) const {
	Fraction otherFraction(wholenumber, 1);
	Fraction fraction = *this;
...
Fraction operator-(int wholeNumber, const Fraction &other) {
	Fraction whole(wholeNumber, 1);
	whole -= other;
	return whole;
}
