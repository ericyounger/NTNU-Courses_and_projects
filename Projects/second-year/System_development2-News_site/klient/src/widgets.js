...
class ButtonSuccess extends Component<{ onClick: () => mixed | null, children?: React.Node }> {
  render() {
    return (
...
class ButtonLight extends Component<{
  ...
  render() {
    return (
      <button type="button" className="btn btn-light btn-outline-secondary" onClick={this.props.onClick}>
        {this.props.children}
      </button>
    );
  }
